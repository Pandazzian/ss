<template>
  <body class="page page-onepager header-ontop page-index-onepager-image-full-height navbar-layout-default">
  ...
  <div id="highlighted">
    ...
    <div class="bg-white overlay overlay-primary overlay-op-8 text-center px-3 py-5 py-lg-10 flex-valign" data-bg-img="theme/assets/img/backgrounds/young-man-standing-in-front-of-concrete-wall-picjumbo-com.jpg" data-css='{"background-position": "center bottom","background-attachment": "fixed"}' data-toggle="full-height">
      <h2 class="display-4 text-white" data-animate="fadeIn" data-animate-delay="0.2">
        Choose <span class="font-weight-bold">AppStrap!</span>
      </h2>
      ...
      <div> <a href="#about" class="btn btn-dark btn-rounded btn-lg py-lg-3 px-lg-5" data-toggle="scroll-link" data-animate="fadeIn" data-animate-delay="0.55">Find Out More</a>
      </div>
    </div>
  </div>
      ...
      <div class="header header-transparent header-dark border-dark border-op-2 sticky-header-dark sticky-bg-dark sticky-bg-op-8">
        ...
        <div class="header-inner container">
          ...
          <div class="header-block order-lg-12">
            ...
            <a href="#top" class="btn btn-link btn-icon text-white sticky-text-light header-btn float-right d-lg-none" data-toggle="collapse" data-target=".navbar-main" data-settings='{"cloneTarget":true, "targetClassExtras": "navbar-offcanvas"}'> <i class="fa fa-bars"></i> </a>
          </div>
          ...
          <div class="navbar navbar-expand-md navbar-expand-collapse navbar-static-top">
            ...
            <div class="navbar-main collapse ">
              ...
              <ul class="nav navbar-nav navbar-nav-onepager">
                ...
                <li class="nav-item"> <a href="#features" data-toggle="scroll-link" class="nav-link"> Features </a> </li>
  ...
  <div id="content" class="p-0">
    ...
    <div id="about" class="py-3 pt-lg-6 pb-lg-0">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6" data-animate="fadeIn" data-animate-delay="0.4" data-animate-offset="100%">
            <p class="lead">Humo lucidus nutus praesent. Defui iustum laoreet nimis nulla olim wisi.</p>
            <p>Accumsan appellatio imputo. Acsi dolor macto nisl patria. Brevitas gravis minim nibh refero. Abdo cui inhibeo lucidus mos utrum.</p>
            <p class="mb-0">Abdo fere praemitto quidem scisco sit sudo tincidunt. Esca iaceo laoreet secundum vicis. Antehabeo esse et oppeto paratus tego tincidunt. Letalis qui tego validus. Ea erat ibidem iustum letalis velit voco ymo.</p>
          </div>
          <div class="col-md-6" data-animate="fadeIn" data-animate-delay="0.8" data-animate-offset="100%">
            ...
            <ul class="fa-ul list-unstyled mt-4 mt-md-0">
              <li class="mb-4">
                ...
                <h4 class="mb-1">
                  Duis Facilisis Letalis Vicis
                </h4>
                Jumentum natu quidem sit valetudo. Augue patria rusticus suscipit uxor.
              </li>
              <li class="mb-3">
                <i class="fa-li fa fa-check text-primary"></i>
                <h4 class="mb-1">
                  Accumsan Luctus Natu Quidne
                </h4>
                Adipiscing huic luptatum nimis nulla nunc patria pecus similis tamen.
              </li>
              <li>
                <i class="fa-li fa fa-check text-primary"></i>
                <h4 class="mb-1">
                  Abdo Caecus Dignissim Lobortis
                </h4>
                Hendrerit sagaciter sit sudo suscipit vereor virtus.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="bg-dark mt-3 mt-lg-6">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-5 divider-diagonal divider-diagonal-r divider-dark" data-bg-img="theme/assets/img/backgrounds/computer-screens.jpg" data-animate="fadeIn" data-animate-delay="0.1"></div>
            <div class="col-lg-4 py-5" data-animate="fadeIn" data-animate-delay="0.3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-10 col-md-11 text-grey">
                  ...
                  <p>Accumsan conventio neo nibh pagus tation verto. At eum gemino huic in oppeto torqueo ulciscor verto.</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-2 col-md-1 text-center"> <i class="fa fa-check text-primary icon-2x"></i>
                ...
                <div class="col-10 col-md-11 text-grey">
                  ...
                  <p>Abluo camur damnum euismod facilisis mos pneum tincidunt tum ymo. Consequat diam dolore letalis nulla obruo quae similis uxor.</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-2 col-md-1 text-center"> <i class="fa fa-check text-primary icon-2x"></i>
                ...
                <div class="col-10 col-md-11 text-grey">
                  ...
                  <p>Feugiat ibidem loquor melior nunc populus ulciscor. Aptent decet eu euismod haero interdico jugis lucidus rusticus.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <hr class="my-0" />
      <div class="bg-light py-3 py-lg-6 overlay overlay-white overlay-op-9" data-bg-img="https://picjumbo.imgix.net/HNCK2530.jpg?q=40&w=3000&sharp=40" data-css='{"background-attachment": "fixed"}'>
        <div class="container">
          <h3>
            Skills Set
          </h3>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="row align-items-center mb-4 no-gutters">
                <div class="col-md-2 text-md-center"><i class="fab fa-fw icon-2x fa-html5 text-primary-dark"></i></div>
                <div class="col-md-10">
                  <h5 class="mt-0">
                    HTML5 (72%)
                  </h5>
                  <div class="progress">
                    <div class="progress-bar w-72" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="row align-items-center mb-4 no-gutters">
                <div class="col-md-2 text-md-center"><i class="fab fa-fw icon-2x fa-css3 text-primary-dark"></i></div>
                <div class="col-md-10">
                  <h5 class="mt-0">
                    CSS3 (99%)
                  </h5>
                  <div class="progress">
                    <div class="progress-bar w-99" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="99" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="row align-items-center mb-4 no-gutters">
                ...
                <div class="col-md-10">
                  ...
                  <div class="progress">
                    <div class="progress-bar w-61" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="61" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="row align-items-center mb-4 no-gutters">
                ...
                <div class="col-md-10">
                  ...
                  <div class="progress">
                    <div class="progress-bar w-62" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="row align-items-center mb-4 no-gutters">
                ...
                <div class="col-md-10">
                  ...
                  <div class="progress">
                    <div class="progress-bar w-85" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="row align-items-center mb-4 no-gutters">
                <div class="col-md-2 text-md-center"><i class="fab fa-fw icon-2x fa-github-alt text-primary-dark"></i></div>
                <div class="col-md-10">
                  <h5 class="mt-0">
                    GitHub (63%)
                  </h5>
                  <div class="progress">
                    <div class="progress-bar w-63" data-toggle="progress-bar-animated-progress" role="progressbar" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- Hiring MDR block -->
    <div class="p-3 text-center text-lg-left bg-dark text-white overlay overlay-primary overlay-op-9" data-animate="fadeIn" data-bg-img="theme/assets/img/backgrounds/zfg9gz7ylcu-dalibor-bosnjakovic.jpg">
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-7 py-2">
            ...
            <h5 class="mb-0">
              We're looking for talented PHP & Wordpress Developers to join our growing team.
            </h5>
          </div>
          <div class="col-12 col-lg-5 py-2 text-lg-right">
            <a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=themelizeme" class="btn btn-lg btn-rounded btn-primary px-4">Join Us <i class="fa fa-thumbs-up ml-2"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="features" class="container py-4 py-lg-6">
      ...
      <div class="row text-center">
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.1">
          ...
          <p>Genitus neque nobis refoveo venio vero. Interdico lobortis pala plaga quibus.</p>
        </div>
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.2">
          ...
          <p>Aptent bene magna valetudo. Aliquam inhibeo molior persto tincidunt velit.</p>
        </div>
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.3">
          ...
          <p>Diam hos jus letalis pertineo quia rusticus similis usitas.</p>
        </div>
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.4">
          ...
          <p>Adipiscing blandit meus natu quis singularis utrum. Blandit elit luctus suscipit validus.</p>
        </div>
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.5">
          ...
          <p>Abdo augue euismod feugiat metuo saluto valetudo volutpat.</p>
        </div>
        <div class="col-lg-4 py-2" data-animate="fadeIn" data-animate-delay="0.6">
          ...
          <p>Cui erat hendrerit sed tego valetudo vulpes. Causa dolor ideo nunc pala tation ullamcorper virtus.</p>
        </div>
      </div>
    </div>
    <!--Pricing Table-->
    ...
    <div class="p-3 p-lg-5 bg-light text-center" data-bg-video="theme/assets/videos/bubbles.mp4" data-animate="fadeIn">
      <div class="container">
    ...
    <div id="projects" class="container p-3 py-lg-6" data-toggle="magnific-popup" data-magnific-popup-settings='{"delegate": "a.project", "gallery":{"enabled":true}}'>
      ...
      <div class="mt-4 owl-nav-over owl-nav-over-lg owl-dots-center" data-toggle="owl-carousel" data-owl-carousel-settings='{"responsive":{"0":{"items":1, "nav":false, "dots":true}, "600":{"items":2, "dots":true}, "940":{"items":3, "nav":true, "dots":true}}, "margin":1, "nav":true, "dots":false}'>
        ...
        <!--Project item 1-->
        <a href="theme/assets/img/projects/project-1.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-1-sm.jpg" alt="Project 1" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Accumsan Diam Et Ille Sed
            </h5>
          </span>
        </a>

        <!--Project item 2-->
        <a href="theme/assets/img/projects/project-2.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-2-sm.jpg" alt="Project 2" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Acsi Minim Nulla Si Suscipere
            </h5>
          </span>
        </a>

        <!--Project item 3-->
        <a href="theme/assets/img/projects/project-3.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-3-sm.jpg" alt="Project 3" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Eum Hos Premo Qui Quia
            </h5>
          </span>
        </a>

        <!--Project item 4-->
        <a href="theme/assets/img/projects/project-4.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-4-sm.jpg" alt="Project 4" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Aliquam Commoveo Illum Meus Pecus
            </h5>
          </span>
        </a>

        <!--Project item 5-->
        <a href="theme/assets/img/projects/project-5.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-5-sm.jpg" alt="Project 5" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Antehabeo Humo Nunc Singularis Suscipit
            </h5>
          </span>
        </a>

        <!--Project item 6-->
        <a href="theme/assets/img/projects/project-6.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-6-sm.jpg" alt="Project 6" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Damnum Natu Quadrum Saepius Sino
            </h5>
          </span>
        </a>

        <!--Project item 7-->
        <a href="theme/assets/img/projects/project-7.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-7-sm.jpg" alt="Project 7" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Decet Dolus Feugiat Iustum Luptatum
            </h5>
          </span>
        </a>

        <!--Project item 8-->
        <a href="theme/assets/img/projects/project-8.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-8-sm.jpg" alt="Project 8" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Acsi Duis Exputo Ratis Vicis
            </h5>
          </span>
        </a>

        <!--Project item 9-->
        <a href="theme/assets/img/projects/project-9.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-9-sm.jpg" alt="Project 9" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Adipiscing Exerci Nulla Scisco Uxor
            </h5>
          </span>
        </a>

        <!--Project item 10-->
        <a href="theme/assets/img/projects/project-10.jpg" class="project overlay-hover">
          <img src="theme/assets/img/projects/project-10-sm.jpg" alt="Project 10" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Abluo Amet Quae Roto Sagaciter
            </h5>
          </span>
        </a>
      </div>
        ...
        <div class="row">
          <div class="col-md-4 d-md-flex">
            <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.1">
              ...
              <small class="text-grey">
                <img src="theme/assets/img/team/jimi.jpg" alt="Jimi Bloggs" class="rounded-circle mr-2" />
          ...
          <div class="col-md-4 d-md-flex">
            <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.2">
              ...
              <small class="text-grey">
                <img src="theme/assets/img/team/steve.jpg" alt="Jimi Bloggs" class="rounded-circle mr-2" />
          ...
          <div class="col-md-4 d-md-flex">
            <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.3">
              ...
              <small class="text-grey">
                <img src="theme/assets/img/team/adele.jpg" alt="Adele Bloggs" class="rounded-circle mr-2" />
    ...
    <div id="contact">
      <div class="container p-4 py-lg-5">
        <div data-animate="fadeIn" data-animate-duration="0.6">
          ...
          <h5 class="text-center font-weight-light mt-2 mb-0 text-muted">
            Make contact about your next project
          </h5>
          <hr class="mb-5 w-50 mx-auto" />
        </div>
        <div class="row" data-animate="fadeIn" data-animate-delay="0.1">
          ...
          <div class="col-md-6">
            <form id="contact-form" action="#" role="form">
              ...
              <input type="button" class="btn btn-outline-primary btn-lg" value="Send Message">
            </form>
          </div>
  ...
  <footer id="footer" class="py-3">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <p class="mb-0 text-sm">Copyright 2020 &copy; AppStrap</p>
...
export default {
  ...
  mounted() {
    let externalScript = [document.createElement('script'),
                          ...
                          document.createElement('script'),
                          document.createElement('script'),]
    externalScript[0].setAttribute('src', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js')
    externalScript[1].setAttribute('src', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js')
    externalScript[2].setAttribute('src', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js')
    externalScript[3].setAttribute('src', 'theme/assets/js/custom-script.js')
    externalScript[4].setAttribute('src', 'theme/assets/js/script.min.js')
    externalScript.forEach(es=>{
...
<style lang="css" scoped>
 @import "theme/assets/css/theme-style.min.css";
 @import "theme/assets/css/custom-style.css";
</style>
